...
passport = st.radio("Does the customer has passport? (Select 1 for Yes, 0 for No)", [0, 1], horizontal=True)
own_car = st.radio("Does the customer owns any car? (Select 1 for Yes, 0 for No)", [0, 1], horizontal=True)
